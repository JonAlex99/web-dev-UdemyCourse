...
const yourBearerToken = "98939424-cd08-450e-bf56-974a62d3c331";
const config = {
...
app.post("/post-secret", async (req, res) => {
  ...
  if (!score.length || !secret.length) res.render("index.ejs", { content: "Both secret and score must have values"})
  try{
