...
app.post("/submit", (req, res) => {
  ...
  const adjLocation = Math.floor(Math.random() * adj.length);
  const nounLocation = Math.floor(Math.random() * noun.length);
  
  const lysing = adj[adjLocation] + " " + noun[nounLocation];

  res.render("index.ejs", {bandName : lysing})
});
